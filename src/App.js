...
class App extends React.Component {
  ...
  render() {
    return (
      <div className="App">
        <Navbar cart="I am a prop for navbar" updateSearchTerm={this.updateSearchTerm} searchTerm={this.state.searchTerm} cart={this.state.cart} checkout={this.checkoutCart}/>
